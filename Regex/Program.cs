...
namespace RegexDemo
{
    class Program
    {
        ...
        {
            var goodInput = "barryd@idunno.org";

            Console.WriteLine("Press Enter to test against a good value");
            Console.ReadLine();

            Console.WriteLine("Result = " +
                RegexChecker.IsValid(goodInput));
            Console.WriteLine();

            var badInput = "t@t.t.t.t.t.t.t.t.t.t.t.t.t.t.t.t.t.t.t.t.t.t.t.t.t.t.t.t.t.t.c%20";

            Console.WriteLine("Press Enter to test against a bad value");
            Console.ReadLine();

            Console.WriteLine("Result = " +
                RegexChecker.IsValid(badInput));
